...
Claude Science adopts a cell-based editing and execution approach similar to Jupyter. The advantage is that users can view variables in the runtime environment in real time, providing a strong sense of interactivity—this is definitely commendable.
...
As a quick exploration tool, it is quite competent, but for research scenarios that require rigorous recording of the analysis process, there is still considerable room for improvement. I hope Anthropic can address this in the future.
