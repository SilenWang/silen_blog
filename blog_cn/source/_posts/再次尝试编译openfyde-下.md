...
换了主板和CPU后，一切都顺畅了... 也不知道是原来主板还是CPU的问题，编译几十分钟就会报错，然后再进行编译又不会在上次的地方报错。这还是我人生第一次真遇到硬件不兼容这种问题... 再次活久见。

于是，编译openfyde的下篇这就来了，可惜在被破硬件折磨的过程中，r132-dev版本的 prebuilt image已经更新了... 没赶上热点呀...

<!-- more -->

其实我上次已经进行到最后几步了，只是在编译chrome这个庞然大物的时候因为我硬件的问题被卡住了。在完成编译后，就可以生成直接刷写到u盘的镜像了。
